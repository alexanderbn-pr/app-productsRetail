...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleProductNotFound(ProductNotFoundException ex) {
        ...
        pd.setTitle(ApiConstants.ERROR_PRODUCT_NOT_FOUND);
    ...
    public ProblemDetail handleIllegalArgument(IllegalArgumentException ex) {
        ...
        pd.setTitle(ApiConstants.ERROR_BAD_REQUEST);
        pd.setDetail(ex.getMessage());
        return pd;
    }
    ...
    public ProblemDetail handleHttpNotFound(HttpClientErrorException.NotFound ex) {
        ...
        ProblemDetail pd = ProblemDetail.forStatus(HttpStatus.NOT_FOUND);
        pd.setTitle(ApiConstants.ERROR_NOT_FOUND);
        pd.setDetail(ex.getMessage());
        return pd;
    }
    ...
    public ProblemDetail handleCircuitBreakerOpen(CallNotPermittedException ex) {
        ...
        pd.setTitle(ApiConstants.ERROR_SERVICE_UNAVAILABLE);
    ...
    public ProblemDetail handleBulkheadFull(BulkheadFullException ex) {
        ...
        pd.setTitle(ApiConstants.ERROR_TOO_MANY_REQUESTS);
    ...
    public ProblemDetail handleGeneric(Exception ex) {
        ...
        pd.setTitle(ApiConstants.ERROR_INTERNAL);
