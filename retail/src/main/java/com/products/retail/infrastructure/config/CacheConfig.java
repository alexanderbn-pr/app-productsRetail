...
public class CacheConfig {
    ...
    public CacheManager cacheManager() {
        ...
        Cache<Object, Object> similarIdsCache = Caffeine.newBuilder()
                ...
                .maximumSize(10_000)
                .build();
        cacheManager.registerCustomCache(InfrastructureConstants.CACHE_SIMILAR_IDS, similarIdsCache);
        ...
        Cache<Object, Object> productDetailsCache = Caffeine.newBuilder()
                ...
                .maximumSize(10_000)
                .build();
        cacheManager.registerCustomCache(InfrastructureConstants.CACHE_PRODUCT_DETAILS, productDetailsCache);
